...
public class Ciclo extends HttpServlet {
    ...
    /*
    Recebe reqisições/chamadas HTTP.
    
    Distingue e emcaminha as diversas requisições/chamadas (verbos) HTTP, como doGet(...)...
 ...
 //       resp.setContentType("text/plain");
    ...
    /*
    Chamado no encerramento do serviço de recebimento de requisições/chamadas (verbos) HTTP pelo servidor, utilizando para a liberação de recurso.
